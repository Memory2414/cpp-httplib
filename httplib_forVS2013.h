...
#define USE_IF2IP
		...
		inline unsigned int str2tag_core(const char *s, size_t l,
			unsigned int h) {
			return (l == 0) ? h
		...
		inline const char *
			...
			if (x == str2tag("css"))	return "text/css";
			else if (x == str2tag("csv"))	return "text/csv";
			else if (x == str2tag("txt")) return "text/plain";
			else if (x == str2tag("vtt")) return "text/vtt";
			else if (x == str2tag("htm")) return "text/html";
			else if (x == str2tag("html")) return "text/html";

			else if (x == str2tag("apng")) return "image/apng";
			else if (x == str2tag("avif")) return "image/avif";
			else if (x == str2tag("bmp")) return "image/bmp";
			else if (x == str2tag("gif")) return "image/gif";
			else if (x == str2tag("png")) return "image/png";
			else if (x == str2tag("svg")) return "image/svg+xml";
			else if (x == str2tag("webp")) return "image/webp";
			else if (x == str2tag("ico")) return "image/x-icon";
			else if (x == str2tag("tif")) return "image/tiff";
			else if (x == str2tag("tiff")) return "image/tiff";
			else if (x == str2tag("jpg")) return "image/jpeg";
			else if (x == str2tag("jpeg")) return "image/jpeg";

			else if (x == str2tag("mp4")) return "video/mp4";
			else if (x == str2tag("mpeg")) return "video/mpeg";
			else if (x == str2tag("webm")) return "video/webm";

			else if (x == str2tag("mp3")) return "audio/mp3";
			else if (x == str2tag("mpga")) return "audio/mpeg";
			else if (x == str2tag("weba")) return "audio/webm";
			else if (x == str2tag("wav")) return "audio/wave";

			else if (x == str2tag("otf")) return "font/otf";
			else if (x == str2tag("ttf")) return "font/ttf";
			else if (x == str2tag("woff")) return "font/woff";
			else if (x == str2tag("woff2")) return "font/woff2";

			else if (x == str2tag("7z")) return "application/x-7z-compressed";
			else if (x == str2tag("atom")) return "application/atom+xml";
			else if (x == str2tag("pdf")) return "application/pdf";
			else if (x == str2tag("js")) return "application/javascript";
			else if (x == str2tag("mjs")) return "application/javascript";
			else if (x == str2tag("json")) return "application/json";
			else if (x == str2tag("rss")) return "application/rss+xml";
			else if (x == str2tag("tar")) return "application/x-tar";
			else if (x == str2tag("xht")) return "application/xhtml+xml";
			else if (x == str2tag("xhtml")) return "application/xhtml+xml";
			else if (x == str2tag("xslt")) return "application/xslt+xml";
			else if (x == str2tag("xml")) return "application/xml";
			else if (x == str2tag("gz")) return "application/gzip";
			else if (x == str2tag("zip")) return "application/zip";
			else if (x == str2tag("wasm")) return "application/wasm";
			return  nullptr;
		}
